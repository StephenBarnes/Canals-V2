...
public class Util {
	...
	public static IntegerProperty FLUID_FINE_LEVEL = IntegerProperty.create("canal_fluid_level", 0, FINE_LEVEL_MAX);
	public static IntegerProperty BLOCK_FINE_LEVEL = IntegerProperty.create("canal_block_level", 0, FINE_LEVEL_MAX);
